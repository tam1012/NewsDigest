          ...
          {#if open}
            <div
              ...
              in:slideScaleFade={{
                ...
                startScale: 0.95,
                slideFrom: 'top',
                slideDistance: '1.5rem',
              }}
              out:fadeOnly={{ duration: 150 }}
              class="grid w-full max-w-sm gap-5 border border-border/60 bg-bg-1 p-6 shadow-lg rounded-3xl outline-none pointer-events-auto"
            >
              ...
              <form onsubmit={handleSubmit} class="flex flex-col gap-3">
                <input
                  ...
                  class="h-9 w-full text-xs rounded-full border border-border bg-transparent px-4 outline-none focus-visible:ring-2 focus-visible:ring-text-main/10 placeholder:text-text-secondary/60 disabled:opacity-50"
                  autofocus
                />
